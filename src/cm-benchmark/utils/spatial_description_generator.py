...
from spatial_transformer import transform_3d_to_2d_with_fov
...
def export_to_json(path_dict, data, json_filename="nav_data.json"):
...
def main(args):
    ...
    export_to_json(output_path, episode_dict, output_filename)
